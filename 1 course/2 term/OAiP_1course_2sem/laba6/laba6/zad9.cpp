...
//
// 
////Создать список, содержащий элементы вещественного типа. Найти среднее значение отрицательных элементов.
// 
...
//    cout << " 4 - Среднее арифметическое отрицательных чисел" << endl;
