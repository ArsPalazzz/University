...
//
// 
// //Создать список, содержащий элементы вещественного типа. Найти сумму элементов, значение каждого из которых меньше 9. 
// 
...
//    frm.close();
//    p = first;
//    cout << "\nСписок считан из файла zad16.dat\n";
//}
//
//void menu(void)     //Вывод меню 
//{
...
//    cout << " 4 - Сумма чисел, меньших 9" << endl;
