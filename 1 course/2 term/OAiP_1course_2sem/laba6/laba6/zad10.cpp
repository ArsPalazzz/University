...
//
// 
// //Создать список, содержащий элементы вещественного типа. Найти произведение элементов, значение каждого из которых меньше 10. 
// 
...
//};
//
//void insert(list*& p, double value, int& count1) //Добавление числа в начало списка
//{
//    list* newP = new list;
...
//    frm.close();
//    p = first;
//    cout << "\nСписок считан из файла zad10.dat\n";
//}
//
//void menu(void)     //Вывод меню 
//{
...
//    cout << " 4 - Произведение чисел, меньших 10" << endl;
//    cout << " 5 - Удаление элемента" << endl;
//    cout << " 6 - Поиск элемента" << endl;
//    cout << " 7 - Выход" << endl;
//}
//
//void mult(list* p)  // Произведение чисел, меньших 10 
//{
//    float mul = 1;
//    if (p == NULL)
//        cout << "Список пуст" << endl;
