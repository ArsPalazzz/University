...
int sumAll(Tree* t);
int sumKEl(Tree* t, int myK);
void kolichOfLeaves(Tree* t);
...
void main()
{
	...
	for (;;)
	{
		...
		cout << "8(Вариант 10)  - вывод суммы значений всех вершин\n";
		cout << "9(Вариант 9)   - вывод количества вершин, значение которых равно k\n";
		cout << "10(Вариант 7)  - вывод количества листьев дерева\n";
		cout << "11(Вариант 12) - количество узлов с четными ключами\n";
		cout << "0 -	выход\n";
		cout << "ваш выбор?\n";
		cin >> choice;
		cout << "\n";
		...
		case 9:  
			...
			scanf_s("%d", &k);
			sumKEl(Root, k);
			printf("Количество вершин, значение которых равно k: %d\n", countK);
			countK = 0;
			break;
		case 10:
			kolichOfLeaves(Root);
...
void kolichOfLeaves(Tree* t) {
	if (t) {
		kolichOfLeaves(t->Right);
		if (t->Right == NULL && t->Left == NULL)
			++leaves;
		kolichOfLeaves(t->Left);
	}
}
