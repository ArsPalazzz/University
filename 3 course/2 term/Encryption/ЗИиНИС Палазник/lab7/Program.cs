...
namespace lab7
{
    class Program
    {
        ...
        //вывод матрицы
        public static int[] SearchError(int[] masXn, int[] masXk, int[,] checkMatrix, int r)
        {
            int n = masXn.Length;
            int k = n - r;
            ...
            Console.WriteLine("\nДеление");
            SearchResidue(masXnSecond, masXk);
            Console.WriteLine();
            Console.WriteLine("\n");
            Console.WriteLine("\nОстаток:");
            OutMass(masXnSecond);
        ...
        public static int[,] AddingLinesMatrixMod2(int[,] matrix, int str1, int str2, int
lengthString)
        {
