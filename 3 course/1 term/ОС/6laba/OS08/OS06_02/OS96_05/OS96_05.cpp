...
int main()
{
    ...
    int* mm = (int*)HeapAlloc(userHeap, HEAP_NO_SERIALIZE | HEAP_ZERO_MEMORY, 100000 * sizeof(int)); // Выделяем память с помощью пользовательской кучи
    cout << "-address = " << hex << mm << ", size = " << dec << 100000 << " \n\n";
