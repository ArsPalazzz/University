...
int main() {
    ...
    /*
        ...
        Страница CF = 270, смещение e0e=3598
        адрес страницы 4096 * 207 = 847 872(10) = 0x000CF000
        смещение 0x0072B830 => 3598 (3596)
        адрес смещения = 847 872 + 3596 = 851 468, 0xCFE0C 
        (851 468)/4 (sizeof(int) = 4) = 212 867 (число которое будет хранится по адресу памяти нашего смещения)
    */

    const int targetPage = 207;
