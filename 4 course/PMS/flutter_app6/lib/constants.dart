...
final List<Dish> dishes = [
  Dish(
    name: "Stuffed Eggs",
    description:
    "Indulge in our luxurious Eggs Stuffed with Caviar, featuring perfectly boiled eggs filled with a rich, creamy mixture of yolks and premium caviar. Garnished with fresh herbs and served on a bed of crisp greens, this dish is a delightful blend of textures and flavors, perfect for a sophisticated appetizer or a lavish brunch.",
    price: 12.99,
    weight: 150,
  ...
  Dish(
    name: "Szechuan Pork",
    description:
    "Experience the bold and spicy flavors of our Szechuan Pork, tender pieces of marinated pork stir-fried to perfection. Served with thick, chewy Udon noodles, and tossed in a fiery Szechuan sauce, this dish is a true culinary adventure. Garnished with fresh cilantro and red chili flakes, it's perfect for those who crave a little heat!",
    price: 15.99,
    weight: 400,
