...
while @@FETCH_STATUS = 0
	begin
		if @Sub like 'ВТЛ%' update SUBJECT set SUBJECT_NAME = 'дада' where current of currentOf
		print '' + @Sub + ' ' + @Sub_Name
		fetch currentOf into @Sub, @Sub_Name
	end
close currentOf
...
update SUBJECT set SUBJECT_NAME = 'Водный транспорт леса' where SUBJECT_NAME = 'дада'