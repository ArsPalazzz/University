...
namespace lab_8
{
    ...
    public partial class MainWindow : Window
    {
        ...
        string createTables()
        {
            return "if not exists(select * from sysobjects where name='Student' and xtype='U') " +
                "begin "+
                "use University " +
                ...
                "use University "+
                "create table [Marks]( " +
                    "MarkCode int primary key identity(1,1), " +
                    "Subject nvarchar(40)," +
                    "Mark int," +
        ...
        //    return
        //       "use University; " +
        //        "insert into Students(NAME, AGE, BIRTHDAY, SEX, FOTO) values " +
        ...
        public MainWindow()
        {
            ...
            SqlConnection sqlConnection0 = new SqlConnection("Data Source=WIN-OLMAANRL9OB;Initial Catalog=University;Persist Security Info=True; User ID = myuser;Password=123 ");
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            //{
                try
                {
                    ...
                    using (SqlConnection connection = new SqlConnection("Data Source=WIN-OLMAANRL9OB;Initial Catalog=University;Persist Security Info=True;User ID = myuser;Password=123 "))
                    {
                        connection.Open();
                        ...
                        if (this.currentTableName == Tables.Marks.ToString())
                        {
            ...
            //else
            //{
            //    MessageBox.Show("Введите возраст >0");
            //}
        }
        ...
        private void ReadFileFromDatabase()
        {
            ...
            {
                connection.Open();
                string sql = "SELECT Id, Surname, Photo FROM Marks";      ///запрос для команды
        ...
        private void TabItem_GotFocus(object sender, RoutedEventArgs e)
        {
            ...
            if (currentTableName == Tables.Marks.ToString())
            {
                currentGrid = MarksGrid;
                currentPrimaryColumnName = PrimaryColumn.ID.ToString();
            }
        ...
        private void Image_MouseEnter(object sender, MouseEventArgs e)
        {
            try
            {
                object rows = StudentGrid.SelectedItem;
                DataRowView rowview = StudentGrid.SelectedItem as DataRowView;
                if(rowview != null)
                {
                    ...
                    try
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection("Data Source=WIN-OLMAANRL9OB;Initial Catalog=University;Persist Security Info=True;User ID = myuser;Password=123 ")) // создаем подключение
                        {
                            ...
                            command.CommandText = @"UPDATE Student set FOTO = @ImageData where id = @StudentId"; // пропишем запрос
                            command.Parameters.Add("@ImageData", SqlDbType.Image, 1000000);
                            command.Parameters.Add("@StudentId", SqlDbType.Int, 0);
